        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForDelivery = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributionLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialMaterialColor", x => new { x.ColorsId, x.MaterialsId });
                    table.ForeignKey(
                        name: "FK_MaterialMaterialColor_MaterialColors_ColorsId",
                        column: x => x.ColorsId,
                        principalTable: "MaterialColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialMaterialColor_Materials_MaterialsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_MaterialColors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "MaterialColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItems_MaterialColors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "MaterialColors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialMaterialColor_MaterialsId",
                table: "MaterialMaterialColor",
                column: "MaterialsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_ColorId",
