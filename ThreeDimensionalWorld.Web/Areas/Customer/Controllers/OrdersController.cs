...
namespace ThreeDimensionalWorld.Web.Areas.Customer.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(IUnitOfWork unitOfWork, ShippingPrice shippingPrice)
        {
        ...
        public IActionResult Confirm()
        {
            ...
            Order order = new Order()
            {
                ...
                DateOfSending = DateTime.Now.AddDays(3),
                PriceForDelivery = session.ShippingCost.AmountTotal / 100m,
                SessionId = session.Id,
                AddressId = (int)TempData["AddressId"]!,
                Price = shoppingCartItems.Select(s => s.GetPrice()).Sum() + session.ShippingCost.AmountTotal / 100m
            };
                ...
                [
                    new SessionShippingOptionOptions()
                    {
                        ShippingRateData = new SessionShippingOptionShippingRateDataOptions()
                        {
                            ...
                            {
                                Amount = (int)(_shippingPrice.Price * 100),
                                Currency = "bgn",
                            },
                            Type = "fixed_amount"
                        }
