class Slideshow {
    ...
    start() {
        this.slideIndex = 1;
        this.slides = Array.from(this.slideshowDOM.getElementsByClassName("slideshow-slides"));
        this.dots = Array.from(this.slideshowDOM.getElementsByClassName("slideshow-dot"));
        this.prev = this.slideshowDOM.querySelector(".slideshow-btn-prev");
        this.next = this.slideshowDOM.querySelector(".slideshow-btn-next");
